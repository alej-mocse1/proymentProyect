  ...
  const [state, setState] = useState([
    {
      ...
      frase:
        " Proyment fue ágil desde el primer contacto, valoro la simplicidad y la rapides para solucionar problemas especificos",
    },
    {
      img: img2,
      name: "Jonh Montoro",
      ...
      frase:
        " Nuestra experiencia con Proyment fue excelente, pudieron brindranos un conjunto de planes orientado a nuestras necesidades. luego de dos meses de arduo trabajo, pudimos cumplir con los objetivos empresariales . ",
    },
    {
      img: img3,
      name: "Matt Cannon",
    ...
    <div className={styles.div}>
      ...
      <div className={styles.divCards}>
        <div className={styles.divChildren1}>
          <h2>
            Proyment fue ágil desde el primer contacto, valoro la simplicidad y
            la rapides para solucionar problemas especificos
          </h2>
        ...
        <div className={styles.divChildren2}>
          <h2>
            Nuestra experiencia con Proyment fue excelente, pudieron brindranos
            un conjunto de planes orientado a nuestras necesidades. luego de dos
            meses de arduo trabajo, pudimos cumplir con los objetivos
            empresariales .
          </h2>
        ...
        <div className={styles.divChildren1}>
          <h2>
            Tivemos que realizar un importante lançamento de marca no Brasil e a
            Proyment contribuiu em grande parte para os ótimos que tivemos
          </h2>
